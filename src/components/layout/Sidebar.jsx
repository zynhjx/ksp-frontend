...
import MyProgramsIcon from '../../assets/icons/MyProgramsIcon';
    ...
    return (
        <aside className={sidebarOpen ? "sidebar extended" : "sidebar shrinked"}>
            ...
            <nav className="lower-nav">
              {(user?.role === "Youth" || user?.role === "SK") && (
                <Link
                  to={myProfilePath}
                  className={`nav-wrapper ${activePath === myProfilePath ? "active" : ""}`}
                ...
                <div className="logout-btn" onClick={handleLogout} data-label="Logout" aria-label="Logout" role="button" tabIndex={0}>
                  <div className="icon-container">
                    <svg className={`logout-icon ${sidebarOpen ? "point-right" : "point-left"}`} viewBox="0 0 24 24" width="26" height="26" fill="white" xmlns="http://www.w3.org/2000/svg">
